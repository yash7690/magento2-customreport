...
namespace Vendor\Module\Model\ResourceModel\Report\MyCustomReport;
...
class Collection extends \Magento\Sales\Model\ResourceModel\Report\Collection\AbstractCollection
{
    ...
    protected $tableForPeriod = [
        'daily'   => 'mycustomreport_aggregated_daily',
        'monthly' => 'mycustomreport_aggregated_monthly',
        'yearly'  => 'mycustomreport_aggregated_yearly',
    ];
